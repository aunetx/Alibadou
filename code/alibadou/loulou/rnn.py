...
if __name__ == '__main__':
    ...
    if learn:
        weights = [np.random.randn(*w) * 0.1 for w in [(784, 200), (200,200), (200,100), (100, 10)]] # Initialiser les poids
        num_epochs, batch_size, learn_rate = 10, 20, 0.01 # Initialiser les hyperparamètres
